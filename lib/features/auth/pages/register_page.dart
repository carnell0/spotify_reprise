...
// Importations nécessaires pour l'AuthBloc
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void _onSignUpPressed() {
    ...
    if (_formKey.currentState!.validate()) {
      // Si le formulaire est valide, effacer le message d'erreur interne
      setState(() {
        _validationMessage = null;
      });
      print('Form is valid! Dispatching SignUp event...');
      // Appeler l'événement d'inscription de l'AuthBloc
      context.read<AuthBloc>().add(
            AuthSignUpRequested(
              email: _emailController.text.trim(),
              password: _passwordController.text.trim(),
              // fullName n'est PAS passé ici, car l'événement AuthSignUpRequested ne le contient plus.
            ),
          );
    } else {
      // Si le formulaire n'est pas valide, afficher un message général pour l'utilisateur
      setState(() {
        ...
        return Scaffold(
          ...
          body: Stack(
            children: [
              ...
              // BlocListener pour gérer les états de l'authentification
              BlocListener<AuthBloc, AuthState>(
                listener: (context, authState) {
                  if (authState is AuthAuthenticated) {
                    // Naviguer vers la page de connexion si l'authentification réussit
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          authState.message,
                          style: TextStyle(color: dynamicForegroundColor), // Utilise la couleur dynamique
                        ),
                    ...
                    setState(() {
                      _validationMessage = authState.message; // Affiche aussi l'erreur Firebase dans le message de validation
                    });
                  }
                },
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          width: double.infinity,
                          child: BlocBuilder<AuthBloc, AuthState>( // Utilisation de BlocBuilder pour le bouton
                            builder: (context, authState) {
                              return ElevatedButton(
                                onPressed: authState is AuthLoading ? null : _onSignUpPressed,
